  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-link active"  style="margin-left: 10px; " aria-current="page" href="admin-home.php">Home</a>
        <a class="nav-link active"  style="margin-left: 10px; color: blue;" aria-current="page" href="admin-ratting.php">Ratting</a>
...
<div class="container" style="margin-top: 50px;">
  <div class="row">
    <div class="p-3 mb-2 bg-dark text-white"><h2>Data Ulasan Masyarakat</h2></div>
    ...
    $id_pelaporan = 1;
		...
		<div class="isi">
			<tr  align="center" style="background-color:white">
				...
				<td><p style="color:blue;"><?php echo $data['ratting']?></p></td>
